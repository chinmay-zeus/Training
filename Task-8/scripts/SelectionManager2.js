...
export class SelectionManager2 {
    /**
    ...
    handleClickLogic(e) {
        ...
        if (x <= this.grid.headerWidth && y > this.grid.headerHeight) {
            ...
            if (rowIndex !== null) {
                if (isCtrl) {
                    this.toggleMultiSelection({ type: 'row', rowIndex });
        ...
        if (y <= this.grid.headerHeight && x > this.grid.headerWidth) {
            ...
            if (colIndex !== null) {
                if (isCtrl) {
                    this.toggleMultiSelection({ type: 'column', colIndex });
        ...
        if (rowIndex !== null && colIndex !== null) {
            if (isCtrl) {
                this.toggleMultiSelection({ type: 'cell', startRow: rowIndex, endRow: rowIndex, startCol: colIndex, endCol: colIndex });
